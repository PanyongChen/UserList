    ...
    render() {
        ...
        return (
            <Table style={{ marginTop: 10, marginBottom: 10 }}>
                <TableHead>
                    <TableRow>
                        <CustomTableCell className="topList">Edit</CustomTableCell>
                        <CustomTableCell className="topList">Delete</CustomTableCell>
                        <CustomTableCell className="topList" onClick={this.sortFn}>
                            First Name
                        </CustomTableCell>
                        <CustomTableCell className="topList" onClick={this.sortLn}>
                            Last Name
                        </CustomTableCell>
                        <CustomTableCell className="topList" onClick={this.sortSex}>
                            Sex
                        </CustomTableCell>
                        <CustomTableCell className="topList" onClick={this.sortAge}>
                            Age
                        </CustomTableCell>
                    </TableRow>
                </TableHead>
